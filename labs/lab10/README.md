[![Build Status](https://travis-ci.org/Aksiniya/lab10.svg?branch=master)](https://travis-ci.org/Aksiniya/lab10)
...
$ go get github.com/github/hub # make it with brew
```
...
$ git push Aksiniya master
$ git tag v0.19.137.1
$ git push Aksiniya master --tags
$ cd ..
```
